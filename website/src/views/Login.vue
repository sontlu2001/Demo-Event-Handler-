  ...
  <div id="app" class="container">
    <b-card
      ...
      <b-form @submit.prevent="handleLogin">
        ...
        <b-button type="submit" variant="primary" class="text-left mt-3"
          >Đăng Nhập</b-button
        >
        <b-button @click="goToRegister" variant="link" class="mt-2"
          >Chưa có tài khoản? Đăng ký ngay</b-button
        >
      </b-form>
    </b-card>
